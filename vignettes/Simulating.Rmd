...
vignette: >
  %\VignetteIndexEntry{Setting up simulations}
...
over multiple replicates? The following code replicates the previous
experiment 3 times, a more useful number of replicates for
understanding these time-series would be around 50.  The data are then
plotted like before.
